...
class CallmeafMediaServiceProvider extends CallmeafServiceProvider implements HasRepo, HasEvent, HasRoute, HasMigration, HasConfig, HasLang
{
    ...
    {
        return MediaRepoInterface::class;
    }
}
